...
const ConvergenceMixin = (superclass) => class extends superclass {
    get convergenceParam() {
        var _a;
        return ((_a = this.findUnitWithTag("hasConvergenceParam")) === null || _a === void 0 ? void 0 : _a.operand) || undefined;
    }
    get convergenceResult() {
        var _a;
        return ((_a = this.findUnitWithTag("hasConvergenceResult")) === null || _a === void 0 ? void 0 : _a.operand) || undefined;
    }
    ...
    addConvergence({ parameter, parameterInitial, parameterIncrement, result, resultInitial, condition, operator, tolerance, maxOccurrences, }) {
        ...
        if (gridProvider) {
            mergedContext = (0, merge_1.default)(gridProvider.yieldData(), param.unitContext);
        ...
        const paramInit = this._UnitFactory.create({
            ...
            tags: [enums_1.UNIT_TAGS.hasConvergenceParam],
        });
        ...
        const storeResult = this._UnitFactory.create({
            ...
            operand: result,
            value: result,
            tags: [enums_1.UNIT_TAGS.hasConvergenceResult],
        });

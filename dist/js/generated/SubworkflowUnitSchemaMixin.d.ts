...
import type { BaseInMemoryEntitySchema, SubworkflowUnitMixinSchema } from "@mat3ra/esse/dist/js/types";
export type SubworkflowUnitSchemaMixin = SubworkflowUnitMixinSchema;
export type SubworkflowUnitInMemoryEntity = InMemoryEntity<BaseInMemoryEntitySchema & SubworkflowUnitSchemaMixin>;

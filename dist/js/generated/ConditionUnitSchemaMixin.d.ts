...
import type { BaseInMemoryEntitySchema, ConditionUnitMixinSchema } from "@mat3ra/esse/dist/js/types";
export type ConditionUnitSchemaMixin = ConditionUnitMixinSchema;
export type ConditionUnitInMemoryEntity = InMemoryEntity<BaseInMemoryEntitySchema & ConditionUnitSchemaMixin>;
